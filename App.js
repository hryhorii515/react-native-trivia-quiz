...
const instructions = 'Test your knowlege about the computer science!!';
    ...
    if (this.state.loading) {
      ...
      return (
        <View style={styles.container}>
          ...
          <Text style={styles.title}>Duration: { Math.ceil((this.state.endTime - this.state.startTime) / 1000) }s</Text>
      ...
      return (
          <View style={styles.container}>
            <Text style={styles.title}>Computer Science Trivia!</Text>
